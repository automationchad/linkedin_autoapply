# LINKEDIN APPLYING TO ENGINEERING JOBS
...
class EasyApplyLinkedIn:
    ...
    def login_linkedin(self):
        ...
        login_email = self.driver.find_element_by_id("username")
        login_email.clear()
    ...
    def job_search(self):
        ...
        # Introduce our keywords and location and hit Enter
    ...
    def filter(self):
        ...
        time.sleep(1)
        apply_filters_button = self.driver.find_element_by_xpath("//button[@data-control-name='all_filters_apply']")
